...
class WriteToFileLayer : public Layer<Dtype> {
 public:

  explicit WriteToFileLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_WRITE_TO_FILE;
  }
