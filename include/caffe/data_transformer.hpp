...
class DataTransformer {
 public:
  ...
  void Transform(const int batch_item_id, const Datum& datum,
                 ...
                 const int preset_channel_start_idx=-1, const int preset_item_channels=-1,
                 const bool preset_transform=false, const bool preset_mirror=false, 
                 const int preset_h_off=-1, const int preset_w_off=-1);
