...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_FLATTEN_BATCH:
    return new FlattenBatchLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_LSTM_CONDITIONAL:
    return new LstmConditionalLayer<Dtype>(param);
  case LayerParameter_LayerType_LSTM_LINEAR:
    return new LstmLinearLayer<Dtype>(param);
  case LayerParameter_LayerType_LSTM_SINGLE_STEP:
    return new LstmSingleStepLayer<Dtype>(param);
  case LayerParameter_LayerType_LSTM_ENC_DEC:
    return new LstmEncDecLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_SOCIAL_POOLING:
    return new SocialPoolingLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_TRACKING_WINDOWS_DATA:
    return new TrackingWindowsDataLayer<Dtype>(param);
  case LayerParameter_LayerType_TRACKING_WINDOWS_SOCIAL_DATA:
    return new TrackingWindowsSocialDataLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_WRITE_TO_FILE:
    return new WriteToFileLayer<Dtype>(param);
